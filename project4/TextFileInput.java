...
public class TextFileInput  {
    ...
    *         null otherwise.
    * @ RuntimeException if the line of text
   ...
   public String[] returnArray() throws NumberFormatException, IOException
   {
	   int length = Integer.valueOf(br.readLine());
	   String[] list = new String[length];
	   for(int i=0; i<length; i++) list[i] = br.readLine();
	   return list;
   }
   
   public int[] returnIntArray(int length) throws NumberFormatException, IOException
   {
	   int[] list = new int[length];
	   for(int i=0; i<length; i++) list[i] = Integer.valueOf(br.readLine());
	   return list;
   }
   
   public int[][] fillArray() throws NumberFormatException, IOException
   {
	   int row = Integer.valueOf(br.readLine());
	   int col = Integer.valueOf(br.readLine());
	   int[][] list = new int[row][col];
	   for(int i=0; i<row; i++) for(int j=0; j<col; j++) list[i][j] = Integer.valueOf(br.readLine());
	   return list;
   }
}  // class TextFileInput
